...
class Service:
    ENABLE_CORS = config.get("SERVICE", "ENABLE_CORS")
    PORT = config.get("SERVICE", "PORT")
    HOST = config.get("SERVICE", "HOST")
    SECURE_COOKIE = config.get("SERVICE", "SECURE_COOKIE")
    VERIFY_SIGNATURE = config.get("SERVICE", "VERIFY_SIGNATURE")
    MAX_LOGIN_ATTEMPTS = config.get("SERVICE", "MAX_LOGIN_ATTEMPTS")
    LOCK_OUT_TIME_MINS = config.get("SERVICE", "LOCK_OUT_TIME_MINS")
    ADD_SESSION_ID = config.get("SERVICE", "ADD_SESSION_ID")
    SECURE_ACCESS = config.get("SERVICE", "SECURE_ACCESS")
    ROBOT_MONITOR_SERVICE = config.get("SERVICE", "ROBOT_MONITOR_SERVICE")